...
\begin{quote}
Desarrollar una aplicaci\'on m\'ovil para la visualizaci\'on interactiva
...
\begin{enumerate}
  \item Diagnosticar la situaci\'on actual de la difusi\'on y el acceso
  ...
  \item Identificar y documentar los requerimientos funcionales y no
    funcionales de la aplicaci\'on m\'ovil, siguiendo las buenas pr\'acticas de la
    ingenier\'ia de requerimientos \citep{sommerville2011}.

  \item Dise\~nar la arquitectura del sistema, incluyendo el modelo de
    datos, la estructura de m\'odulos y la interfaz de usuario, mediante
    diagramas y wireframes de baja fidelidad.

  \item Desarrollar el m\'odulo de visualizaci\'on interactiva basado en
    mapas georreferenciados, que permita ubicar los escenarios deportivos y
    consultar su informaci\'on de manera intuitiva.

  \item Implementar la aplicaci\'on m\'ovil multiplataforma, integrando las
    funcionalidades definidas en el alcance del producto m\'inimo viable.

  \item Evaluar la usabilidad, el rendimiento y la satisfacci\'on de los
