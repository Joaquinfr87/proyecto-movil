...
\begin{figure}[H]
\centering
  \figuraAPA{fig:infraestructura-deportiva}{Imagen ilustrativa de los escenarios deportivos del pa\'is}{%
    \includegraphics[width=0.62\linewidth]{escenarios-deportivos.jpeg}%
  }{Elaboraci\'on propia en base a la revisi\'on documental del sector deportivo.}
\end{figure}
