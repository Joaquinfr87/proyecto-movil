...
Durante ese lapso la interfaz muestra un indicador de carga en cada una
de las secciones principales (favoritos, gesti\'on y buscador). Cuando
ocurre una falla de conexi\'on, el estado de error se presenta de forma
controlada y consistente en las mismas secciones y tambi\'en en el mapa.
Las evidencias de ambos estados se muestran en la secci\'on de
evidencias del presente avance.
