  ...
  \contenidoConFuente{%
    \begin{tablaAPA}
      \begin{tabular}{@{}p{3.4cm}p{4.0cm}p{8.2cm}@{}}
        ...
        \midrule
        \texttt{react-hook-form} & \texttt{\^{}7.85.0} & Gestor de formularios
        ligero que reduce re-renders innecesarios y simplifica la
        validaci\'on de campos. \\\
        \addlinespace
        \texttt{@hookform/resolvers} & \texttt{\^{}5.9.0} & Integraci\'on de
        \texttt{react-hook-form} con esquemas de validaci\'on externos como
        Zod. \\\
        \addlinespace
        \texttt{Zod} & \texttt{\^{}4.4.3} & Librer\'ia de validaci\'on y
