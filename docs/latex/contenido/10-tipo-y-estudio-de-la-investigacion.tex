...
es de tipo \textbf{exploratoria} y \textbf{descriptiva}, seg\'un la
clasificaci\'on propuesta por Dankhe (1986), citada por \citet{hernandez2014}:

\begin{itemize}
  \item \textbf{Exploratoria:} porque la aplicaci\'on de sistemas de
  ...
  \item \textbf{Descriptiva:} porque el objetivo consiste en especificar las
