...
\begin{table}[H]
  ...
  \contenidoConFuente{%
    \begin{tablaAPA}
    \begin{tabular}{@{}p{3.0cm}p{9.2cm}p{2.4cm}@{}}
      \toprule
      \textbf{Concepto} & \textbf{Definici\'on} & \textbf{Fuente} \\
      \midrule
      Sistema de informaci\'on &
      Componentes interrelacionados que recolectan, procesan y distribuyen
      informaci\'on para la toma de decisiones &
      \citet{kendall2011} \\
      \addlinespace
      Ingenier\'ia de software &
      Principios de ingenier\'ia aplicados al desarrollo sistem\'atico
      de software con calidad &
      \citet{pressman2010} \\
      \addlinespace
      SIG &
      Herramientas para capturar, almacenar y presentar informaci\'on
      geogr\'aficamente referenciada &
      \citet{longley2015} \\
      \addlinespace
      Georreferenciaci\'on &
      Asociaci\'on de un elemento a una posici\'on \'unica en la
      superficie terrestre mediante coordenadas &
      \citet{longley2015} \\
      \addlinespace
      Visualizaci\'on interactiva &
      Representaci\'on gr\'afica de datos que el usuario explora y
      modifica de forma din\'amica &
      \citet{longley2015} \\
      \addlinespace
      Mapa interactivo &
      Mapa digital que permite navegar, hacer zoom y consultar
      informaci\'on asociada a cada elemento &
      \citet{leaflet} \\
      \addlinespace
      Escenario deportivo &
      Infraestructura destinada a la pr\'actica de disciplinas
      deportivas &
      Elaboraci\'on propia \\
      \addlinespace
      Aplicaci\'on multiplataforma &
      App que se ejecuta en m\'ultiples sistemas operativos a partir
      de un \'unico c\'odigo base &
      \citet{pressman2010} \\
      \addlinespace
      MVP &
      Versi\'on m\'as peque\~na del producto que aporta valor real y
      permite validaci\'on con retroalimentaci\'on temprana &
      \citet{larman2004} \\
      \addlinespace
      ...
      Restricci\'on que el sistema debe cumplir (rendimiento,
      seguridad, usabilidad) &
      \citet{sommerville2011} \\
      \addlinespace
      Usabilidad &
      Facilidad con la que los usuarios aprenden y utilizan
      una interfaz &
      \citet{nielsen1994} \\
      \addlinespace
      Calidad de software &
      Grado en que un producto satisface los atributos de calidad
      establecidos en modelos est\'andar &
      \citet{iso25010} \\
      \addlinespace
      Wireframe &
      Esquema de baja fidelidad que representa la estructura de
      una interfaz &
      \citet{pressman2010} \\
      \addlinespace
      Cliente--servidor &
      Modelo de computaci\'on distribuida en el que los clientes
      solicitan servicios a un servidor central &
      \citet{sommerville2011} \\
      \bottomrule
    \end{tabular}
    \end{tablaAPA}%
