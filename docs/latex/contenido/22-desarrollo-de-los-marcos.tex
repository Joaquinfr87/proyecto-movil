...
m\'ovil y el sistema web constituyen los clientes, el backend (Node.js con
...
La usabilidad es un elemento central del presente proyecto: la interfaz del
sistema web y m\'ovil debe ser intuitiva para asistentes, gestores y
...
web o m\'ovil concentra la l\'ogica de negocio y la comunicaci\'on con la base de
...
sociales actuales hacen viable y pertinente la propuesta de un sistema web y
...
poblaci\'on. Esta norma sustenta la base legal del desarrollo del sistema web y
m\'ovil propuesto, as\'i como las decisiones tecnol\'ogicas presentadas en el
cap\'itulo III.
