...
A partir de lo expuesto en los antecedentes, la situaci\'on
...
El objeto de estudio del presente proyecto es el proceso de difusi\'on
  ...
  \contenidoConFuente{%
    \begin{tablaAPA}
      \begin{tabular}{@{}p{4.2cm}p{3.0cm}p{4.2cm}p{3.6cm}@{}}
        ...
        Sistema m\'ovil con mapa de instalaciones y reservas &
      ...
      \end{tabular}
    \end{tablaAPA}%
  }{Elaboraci\'on propia en base a la revisi\'on documental de plataformas deportivas.}
\end{table}
...
\begin{figure}[H]
\centering
  \figuraAPA{fig:arbol-causas-efectos}{\'Arbol de causas y efectos expandido del problema identificado}{%
  \begin{tikzpicture}[
