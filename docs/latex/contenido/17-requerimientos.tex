% ============================================================================
%  SECCIÓN 2.4: REQUERIMIENTOS PRELIMINARES
% ============================================================================
...
continuaci\'on se presentan los requerimientos preliminares del sistema web y
...
\begin{table}[H]
  ...
  \begin{tablaAPA}
    \begin{tabular}{@{}p{2.0cm}p{3.4cm}p{10.4cm}@{}}
      ...
      sistemas operativos iOS y Android, y el sistema web en los navegadores
      m\'as utilizados. \\
      \addlinespace
