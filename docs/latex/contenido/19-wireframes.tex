% ============================================================================
%  SECCIÓN 3.7: WIREFRAMES INICIALES
% ============================================================================
...
\begin{figure}[H]
\centering
  \figuraAPA{fig:wireframes-acceso}{Wireframes de baja fidelidad de las pantallas de acceso}{%
  \begin{tikzpicture}[
    ...
    \end{scope}
  \end{tikzpicture}%
  }{Elaboraci\'on propia en base a los wireframes iniciales del sistema.}
\end{figure}

\begin{figure}[H]
\centering
  \figuraAPA{}{Wireframes de baja fidelidad de las pantallas principales}{%
  \begin{tikzpicture}[
      tel/.style={draw=black!70, thick, rounded corners=4pt, minimum width=3.2cm, minimum height=6.2cm},
      zona/.style={draw=black!45, thin, rounded corners=1pt, fill=gray!8},
      etiqueta/.style={font=\scriptsize\itshape, align=center},
