...
% [Este apartado será completado por el equipo de desarrolladores: integrantes,
%  roles de cada uno y responsable o representante del equipo.]

\emph{[Apartado por completar por el equipo de desarrolladores: integrantes,
roles de cada uno y responsable o representante del equipo.]}
...
\begin{figure}[H]
  \centering
  \caption{Mapa de funcionalidades de la aplicaci\'on \nombreApp{}}
  \label{fig:mapa-funcionalidades}
  \contenidoConFuente{%
  \begin{tikzpicture}[
