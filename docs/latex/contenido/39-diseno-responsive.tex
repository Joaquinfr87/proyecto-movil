  ...
  \contenidoConFuente{%
    \begin{tablaAPA}
      \begin{tabular}{@{}p{3.4cm}p{12.2cm}@{}}
        \toprule        \textbf{Propiedad} & \textbf{Aplicaci\'on} \\midrule        \textit{flex: 1} & Permite que un contenedor ocupe todo el espacio
        disponible, distribuyendo el espacio proporcionalmente entre los
        elementos hijos. \\addlinespace        \textit{flexDirection: 'column'} & Organiza los elementos de arriba
        hacia abajo (layout vertical), patr\'on principal de las pantallas. \\addlinespace        \textit{flexDirection: 'row'} & Organiza los elementos de izquierda a
        derecha (layout horizontal), utilizado en footers y barras de
        herramientas. \\addlinespace        \textit{alignItems: 'center'} & Centra los elementos hijos
        horizontalmente dentro de su contenedor. \\addlinespace        \textit{justifyContent: 'center'} & Centra los elementos hijos
        verticalmente dentro de su contenedor. \\addlinespace        \textit{justifyContent: 'space-between'} & Distribuye el espacio
        uniformemente entre los elementos, utilizado en el splash. \\bottomrule
      \end{tabular}
    \end{tablaAPA}%
