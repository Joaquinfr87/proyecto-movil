...
- **Filosofia:** Rapido, funcional, iterativo. Los agentes de IA ejecutan gran parte del codigo, el equipo supervisa y integra.
...
┌─────────────────────────────────────────┐
│            FRONTEND (Expo)              │
│  React Native + Expo Router + Leaflet   │
└──────────────┬──────────────────────────┘
               │
               ▼
┌─────────────────────────────────────────┐
...
- Pantalla de mapa con Leaflet/react-native-maps
...
| **react-native-maps** | Mapa nativo (mejor que Leaflet en Expo) |
