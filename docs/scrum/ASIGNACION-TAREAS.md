...
### Esquema SQL que debe crear Nicolas (Dia 1)
...
CREATE TABLE usuarios (
  ...
  rol TEXT DEFAULT 'asistente' CHECK (rol IN ('asistente', 'gestor', 'admin')),
